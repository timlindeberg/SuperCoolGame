...
struct BeginBox{
	BeginBox(Format::Code color, Format::Code style = Format::NONE);
...
private:
	...
	static const std::string DELIMITER_LEFT;
	static const std::string DELIMITER_RIGHT;
	static const std::string DELIMITER_HORIZONTAL;
